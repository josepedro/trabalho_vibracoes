...
title( ... 
'Espectro de Frequencias do Deslocamento de Entrada (Aplicado nas Massas 2 e 1)', ... 
'Interpreter','latex','FontSize',16);
xlabel('Frequencias [Hz]','Interpreter','latex','FontSize',16); 
ylabel('Magnitude','Interpreter','latex','FontSize',16);
subplot(2,1,2);
plot(frequencias_excitacao, abs(espectro_frequencia_resultante_saida));
axis([0 1000 min(abs(espectro_frequencia_resultante_saida)) ...
...
title( ... 
'Excitacao de Deslocamento de Entrada (Aplicado nas Massas 2 e 1)', ... 
'Interpreter','latex','FontSize',16);
